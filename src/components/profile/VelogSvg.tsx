/**
 * svg Component 공통 types
 * extends React.ComponentProps<"svg">
 * @type w number | undefined
 * @type h number | undefined
 */
export interface SvgType extends React.ComponentProps<"svg"> {
  w?: number;
  h?: number;
}
 ...
 * @returns Velog Svg Component
 */
const VelogSvg = ({ w, h, ...rest }: SvgType) => {
  return (
    <svg
      role="img"
      width={w}
